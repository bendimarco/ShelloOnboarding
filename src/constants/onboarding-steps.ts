...
export const onboardingSteps: OnboardingStep[] = [
  {
    ...
    contentType: 'video',
    content: `${basePath}/videos/intro_spin.mp4`,
  ...
  },
  {
    ...
    contentType: 'video',
    content: `${basePath}/videos/power_hold.mp4`,
    actionLabel: 'Continue',
    section: 'Getting Started',
    backgroundColor: '#212121',
    faq: true
  },
  {
    ...
    contentType: 'video',
    content: `${basePath}/videos/needs_charge.mp4`,
    actionLabel: 'Continue',
    section: 'Getting Started',
  ...
  },
  {
    ...
    contentType: 'video',
    content: `${basePath}/videos/charging_port.mp4`,
    actionLabel: 'Continue',
    section: 'Getting Started',
  ...
  // },
  {
    ...
    contentType: 'video',
    content: `${basePath}/videos/charging.mp4`,
    actionLabel: 'Continue',
    section: 'Getting Started',
    backgroundColor: '#012719',
    faq: true
  ...
  },
  {
    ...
    contentType: 'video',
    content: `${basePath}/videos/bluetooth_hold.mp4`,
    actionLabel: 'Continue',
  ...
  },
  {
    ...
    contentType: 'video',
    content: `${basePath}/videos/pairing_mode.mp4`,
    actionLabel: 'Continue',
    section: 'Connecting Shello',
  ...
  // },
  {
    ...
    contentType: 'image',
    content: `${basePath}/images/confirm_bluetooth.png`,
    actionLabel: 'Continue',
    section: '',
    backgroundColor: '#000224',
    faq: true
  ...
  },
  {
    ...
    contentType: 'image',
    content: `${basePath}/images/app.svg`,
    actionLabel: 'Continue',
  ...
  },
  {
    ...
    contentType: 'image',
    content: `${basePath}/images/wearing_shello.png`,
    actionLabel: 'Continue',
    section: 'Preparing to Record',
    backgroundColor: '#212121',
    faq: true
  },
  {
    ...
    contentType: 'image',
    content: `${basePath}/images/new_interview_btn.png`,
    actionLabel: 'Continue',
    section: 'Preparing to Record',
    backgroundColor: '#212121',
    faq: true
  },
  {
    ...
    contentType: 'image',
    content: `${basePath}/images/input_info.png`,
    actionLabel: 'Continue',
    section: 'Preparing to Record',
    backgroundColor: '#212121',
    faq: true
  ...
  // }, 
  {
    ...
    contentType: 'video',
    content: `${basePath}/videos/start_recording.mp4`,
    actionLabel: 'Continue',
  ...
  // }, 
  {
    ...
    description: 'You can confirm Shello is recording via the app and the red recording indicator on Shello itself.',
    contentType: 'image',
    content: `${basePath}/images/recording_light.png`,
    actionLabel: 'Continue',
    section: 'Recording an Interview',
    backgroundColor: '#212121',
    faq: true
  }, 
  {
    ...
    contentType: 'image',
    content: `${basePath}/images/recording_length.png`,
    actionLabel: 'Continue',
    section: 'Recording an Interview',
    backgroundColor: '#212121',
    faq: true
  }, 
  {
    ...
    contentType: 'image',
    content: `${basePath}/images/recording_transcript.png`,
    actionLabel: 'Continue',
    section: 'Recording an Interview',
    backgroundColor: '#212121',
    faq: true
  }, 
  {
    ...
    contentType: 'video',
    content: `${basePath}/videos/recording_bookmark.mp4`,
    actionLabel: 'Continue',
    section: 'Recording an Interview',
    backgroundColor: '#212121',
    faq: true
  }, 
  {
    ...
    contentType: 'image',
    content: `${basePath}/images/recording_stop_pause.png`,
    actionLabel: 'Continue',
    section: 'Recording an Interview',
    backgroundColor: '#212121',
    faq: true
  }, 
  {
    ...
    contentType: 'image',
    content: `${basePath}/images/confirm_recording_end.png`,
    actionLabel: 'Continue',
    section: 'Recording an Interview',
    backgroundColor: '#212121',
    faq: true
  }, 
  {
    ...
    contentType: 'image',
    content: `${basePath}/images/quick_summary.png`,
    actionLabel: 'Continue',
  ...
  }, 
  {
    ...
    contentType: 'image',
    content: `${basePath}/images/view_full_interview.png`,
    actionLabel: 'Continue',
    section: 'After Interview',
    backgroundColor: '#212121',
    faq: true
